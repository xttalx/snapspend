...
export function Snap({ size = 40, mood = 'happy', style }) {
...
export function SnapWordmark({ size = 24 }) {
  return (
...
export function Avatar({ size = 28, mood }) {
  return (
    <div style={{
...
export function Phone({ children, dark = false, time = '9:41' }) {
  return (
...
// Bottom nav (dock)
export function Dock({ active = 'home', onNav }) {
  const tabs = [
...
// App bar
export function AppBar({ title, onBack, action }) {
  return (
...
export function ImgPlaceholder({ w = '100%', h = 180, label = 'photo', radius = 14 }) {
  return (
    <div style={{
      width: w, height: h,
      borderRadius: radius,
